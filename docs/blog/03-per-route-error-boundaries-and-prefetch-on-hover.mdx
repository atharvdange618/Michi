...
The [previous post](/blog/layout-that-persists-and-data-that-arrives-before-you-do) covered nested layouts and data loaders: how a persistent navbar survives navigation, and how `useLoaderData()` gets data onto the screen before the component even mounts. That's the happy path. This post covers what happens when the happy path breaks, and how to make the happy path feel faster than it actually is.
