...
<Callout type="warning">
  **The route order trap:** If you put `/user/$id` before `/user/settings`, the
  ...
  declare static routes before dynamic ones. This is the most common routing bug
  in custom routers.
</Callout>
